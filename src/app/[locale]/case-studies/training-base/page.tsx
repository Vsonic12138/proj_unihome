...
const SLUG = "case-studies-training-base";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates({ locale, pathSuffix: "/case-studies/training-base" }),
  };
}

const TrainingBaseCasesPage = async ({ params }: PageParams) => {
  const { locale } = await params;
  const isPreview = (await draftMode()).isEnabled;
  if (isPreview) noStore();
...
export default TrainingBaseCasesPage;
