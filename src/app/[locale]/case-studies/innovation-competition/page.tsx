...
const SLUG = "case-studies-innovation-competition";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates({ locale, pathSuffix: "/case-studies/innovation-competition" }),
  };
}

const InnovationCompetitionCasesPage = async ({ params }: PageParams) => {
  const { locale } = await params;
  const isPreview = (await draftMode()).isEnabled;
  if (isPreview) noStore();
...
export default InnovationCompetitionCasesPage;
