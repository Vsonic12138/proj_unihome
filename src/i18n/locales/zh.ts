    ...
    products: {
      ...
      details: {
        "ubot-mr205": {
          ...
          applicable: "K12、中职/高职一年级、大一",
          configuration: [
            "传感器：姿态检测、4 路巡线、2 个超声波、语音识别、喇叭、PS 手柄",
            "控制器：支持图形化 / C++ / Python，6 路直流电机 + 8 路舵机接口",
          ],
          experiments: [
            "32 个实验：电机控制、底盘搭建、传感器应用、综合项目（如机器人走迷宫 / 语音控制）",
          ],
          specs: [
            "6 种底盘、3 种机械臂、20 种复合机器人形态",
