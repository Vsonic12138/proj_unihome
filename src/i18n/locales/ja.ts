    ...
    products: {
      ...
      details: {
        ...
        "gx-mat-09s": {
          ...
          image: "/images/video/video.jpg",
          overview:
            "カリキュラム設計プラットフォームを基盤にセンシングと計算能力を強化。LiDAR と RDK X5 ボードを追加し、より多様な構成と研究開発をサポートします。",
          highlights: [
            "ハードウェア強化：LiDAR、単眼カメラ、RDK X5 ボード（9TOPS、Ubuntu+ROS プリインストール）",
            "構成拡張：11 種のシャーシ（6 輪六駆差動シャーシを含む）、7 種のロボットアーム（8 自由度デュアルアームを含む）",
            "88 種類の複合形態",
          ],
          applicable: "大学上級課程、研究開発",
          experiments: [
            "組込み開発：Ubuntu 操作、GPIO 制御",
            "ROS 応用：パッケージ移植、URDF シミュレーション",
            "高度なコンピュータビジョン：YOLO デプロイ、人顔認識",
          ],
          specs: [
            "エンコーダ付き DC モータを 6 基に増設",
            "LiDAR（測距 0.12–8m）を追加",
          ],
        },
        "rai-p4": {
