...
type ArticleCopy = Dictionary["blogDetailPage"]["article"];
type BlogLabels = Dictionary["blog"]["labels"];
...
const ArticleContent = ({ article, labels, shareLabel }: ArticleContentProps) => {
  return (
    <article>
          ...
          <div className="mr-10 mb-5 flex items-center">
            ...
            <div className="w-full">
              <span className="text-body-color mb-1 text-base font-medium">
                {labels.by} <span>{article.meta.author}</span>
              </span>
            </div>
          </div>
      ...
      <div>
        <p className="text-body-color mb-10 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          {article.intro}
        </p>
        ...
        <p className="text-body-color mb-8 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          {article.highlightParagraph.before}
          <strong className="text-primary dark:text-white">
            {article.highlightParagraph.highlight}
          </strong>
          {article.highlightParagraph.after}
        </p>
        <p className="text-body-color mb-10 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          {article.emphasisParagraph.before}
          <span className="text-primary underline dark:text-white">
            {article.emphasisParagraph.highlight}
          </span>
          {article.emphasisParagraph.after}
        </p>
        ...
        <div className="items-center justify-between sm:flex">
          ...
          <SharePost ariaLabel={shareLabel} />
            </div>
          </div>
        </div>
      </div>
